...
Sub auto_open(Optional bRanFromFirstOpen As Boolean = True)
    ...
    If System Is Nothing Then
        Set System = New FraSys
    End If
    Call System.InitialiseSystemConfig 'TODO: Load any config required to system singleton here.
...
'TODO: This needs to interact with the ROWs in the ReportList sheet instead.
    ...
    thepath = System.ROOT_PATH
    USERNAME = System.USERNAME
    USERPASSWORD = System.USERPASSWORD
    
    SERVER = System.SERVER
    DATABASE = System.DATABASE
    save_destination = """" + thepath + "\paramdefs.xml" + """"
    
    path = System.SIMS_PATH + "\CommandReporter.exe"
...
'   Save as new workbook
    ...
    ActiveWorkbook.SaveCopyAs Filename:= _
        System.ROOT_PATH + "\Todays_Output.xlsm"
    ActiveWorkbook.SaveCopyAs Filename:= _
        System.ROOT_PATH + "\Todays_Output (" & sYear & "-" & sMonth & "-" & sDate & ").xlsm"
